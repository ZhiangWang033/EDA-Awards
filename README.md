<div align="center">
  ...
  <h1>EDA Technology Insights</h1>
  <p><strong>Physical Design-Related Papers</strong></p>
  <p><strong>115 papers</strong> &nbsp;&middot;&nbsp; <strong>8 conferences</strong> &nbsp;&middot;&nbsp; <strong>2015-2026</strong></p>
  <p><a href="#iccad">ICCAD</a> &nbsp;&middot;&nbsp; <a href="#ispd">ISPD</a> &nbsp;&middot;&nbsp; <a href="#date">DATE</a> &nbsp;&middot;&nbsp; <a href="#asp-dac">ASP-DAC</a> &nbsp;&middot;&nbsp; <a href="#dac">DAC</a> &nbsp;&middot;&nbsp; <a href="#gvlsi">GVLSI</a> &nbsp;&middot;&nbsp; <a href="#mlcad">MLCAD</a> &nbsp;&middot;&nbsp; <a href="#iccd">ICCD</a></p>

</div>

---

A curated collection of award-winning and nominated papers related to physical design, including placement, routing, clock tree synthesis, power delivery, reliability, lithography, packaging, and thermal analysis.
...
### 1. Defect Clustering-Aware Spare-TSV Allocation for 3D ICs

> **Authors:** Shengcheng Wang; Mehdi B. Tahoori; Krishnendu Chakrabarty
>
...
### 2. Fast Physics-Based Electromigration Checking for On-Die Power Grids

> **Authors:** Sandeep Chatterjee; Valeriy Sukharev; Farid N. Najm
>
...
### 3. Improved Flop Tray-Based Design Implementation for Power Reduction

> **Authors:** Andrew B. Kahng; Jiajia Li; Lutong Wang
>
...
### 4. SALT: Provably Good Routing Topology by a Novel Steiner Shallow-Light Tree Algorithm

> **Authors:** Gengjie Chen; Peishan Tu; Evangeline F. Y. Young
>
...
### 5. Cost-Effective Design of Scalable High-Performance Systems using Active and Passive Interposers

> **Authors:** Dylan Stow; Yuan Xie; Taniya Siddiqua; Gabriel H. Loh
>
...
### 6. Analytical Solution of Poisson's Equation and Its Application to VLSI Global Placement

> **Authors:** Wenxing Zhu; Zhipeng Huang; Jianli Chen; Yao‐Wen Chang
>
...
### 7. Power Grid Fixing for Electromigration-Induced Voltage Failures

> **Authors:** Zahi Moudallal; Valeriy Sukharev; Farid N. Najm
>
...
### 8. NanoTherm: An Analytical Fourier-Boltzmann Framework for Full Chip Thermal Simulations

> **Authors:** Shashank Varshney; Hameedah Sultan; Palkesh Jain; Smruti R. Sarangi
>
...
### 9. Electromigration Checking Using a Stochastic Effective Current Model

> **Authors:** Adam Issa; Valeriy Sukharev; Farid N. Najm
>
...
### 10. GridNet: Fast Data-Driven EM-Induced IR Drop Prediction and Localized Fixing for On-Chip Power Grid Networks

> **Authors:** Han Zhou; Wentian Jin; Sheldon X.-D. Tan
>
...
### 11. Analytical Modeling of Transient Electromigration Stress based on Boundary Reflections
...
### 12. pGRASS-Solver: A Parallel Iterative Solver for Scalable Power Grid Analysis Based on Graph Spectral Sparsification

> **Authors:** Zhiqiang Liu; Wenjian Yu
>
...
### 13. SpecPart: A Supervised Spectral Framework for Hypergraph Partitioning Solution Improvement
...
### 14. DeePEB: A Neural Partial Differential Equation Solver for Post Exposure Baking Simulation in Lithography

> **Authors:** Qipan Wang; Xiaohan Gao; Yibo Lin; Runsheng Wang; Ru Huang
>
...
### 15. A Neural-Ordinary-Differential-Equations Based Generic Approach for Process Modeling in DTCO: A Case Study in Chemical-Mechanical Planarization and Copper Plating

> **Authors:** Yue Qian; Lan Chen
>
...
### 17. Fusion of Global Placement and Gate Sizing with Differentiable Optimization

> **Authors:** Yufan Du; Zizheng Guo; Yibo Lin; Runsheng Wang; Ru Huang
>
...
### 18. Semidefinite Programming-Based Decoupling Capacitor Placement for Power Distribution Network Optimization

> **Authors:** Zong-Ying Cai; Wei-Han Mao; Yao-Wen Chang; Yang Lu; Jerry Bai; Bin-Chyi Tseng
>
...
### 19. CLASS: A Controller-Centric Layout Synthesizer for Dynamic Quantum Circuits
...
### 20. GTA: GPU-Accelerated Track Assignment with Lightweight Lookup Table for Conflict Detection

> **Authors:** Chunyuan Zhao; Jiarui Wang; Xun Jiang; Jincheng Lou; Yibo Lin
>
> **Affiliations:** Peking University
>
> **Year:** `2025` &nbsp;&middot;&nbsp; **Conference:** `ICCAD` &nbsp;&middot;&nbsp; **Award:** Best Paper Nomination
...
> **Authors:** Chen-Han Lu; Wenhao Liu; Haoxing Ren; Ting-Chi Wang
>
...
### 22. LMLitho: A Large Vision Model-Driven Lithography Simulation Framework

> **Authors:** Zhen Wang; Hongquan He; Tao Wu; Xuming He; Qi Sun; Cheng Zhuo; Bei Yu; Jingyi Yu; Hao Geng
>
...
> **Authors:** Hsi-An Chien; Szu-Yuan Han; Ye‐Hong Chen; Ting-Chi Wang
>
...
### 2. Timing-Driven Placement Based on Dynamic Net-Weighting for Efficient Slack Histogram Compression

> **Authors:** Chrystian Guth; Vinicius Livramento; Renan Netto; Renan Fonseca; José Luís Güntzel; Luiz C. V. dos Santos
>
...
### 3. Generating Routing-Driven Power Distribution Networks with Machine-Learning Technique

> **Authors:** Wen-Hsiang Chang; Li-De Chen; Chien-Hsueh Lin; Szu-Pang Mu; Mango C.-T. Chao; Cheng-Hong Tsai; Yen-Chih Chiu
>
...
### 4. Bilinear Lithography Hotspot Detection

> **Authors:** Hang Zhang; Fengyuan Zhu; Haocheng Li; Evangeline F. Y. Young; Bei Yu
>
...
### 5. Automatic Cell Layout in the 7nm Era

> **Authors:** Pascal Cremer; Stefan Hougardy; Jan Schneider; Jannik Silvanus
>
...
### 6. Pin Accessibility-Driven Detailed Placement Refinement

> **Authors:** Yixiao Ding; Chris Chu; Wai-Kei Mak
>
...
### 7. Prim-Dijkstra Revisited: Achieving Superior Timing-driven Routing Trees

> **Authors:** Charles J. Alpert; Wing-Kai Chow; Kwangsoo Han; Andrew B. Kahng; Zhuo Li; Derong Liu; Sriram Venkatesh
>
...
### 8. Compact-2D: A Physical Design Methodology to Build Commercial-Quality Face-to-Face-Bonded 3D ICs
...
### 9. Pin Assignment Optimization for Multi-2.5D FPGA-based Systems

> **Authors:** Wan-Sin Kuo; Shi-Han Zhang; Wai-Kei Mak; Richard Sun; Yoon Kah Leow
>
...
### 10. Pin Access-Driven Design Rule Clean and DFM Optimized Routing of Standard Cells under Boolean Constraints

> **Authors:** Nikolay Ryzhenko; Steven Burns; Anton Sorokin; Mikhail Talalay
>
...
### 11. Device Layer-Aware Analytical Placement for Analog Circuits

> **Authors:** Biying Xu; Shaolan Li; Chak-Wa Pui; Derong Liu; Linxiao Shen; Yibo Lin; Nan Sun; David Z. Pan
>
...
### 12. How Deep Learning Can Drive Physical Synthesis Towards More Predictable Legalization
...
### 13. TEMPO: Fast Mask Topography Effect Modeling with Deep Learning

> **Authors:** Wei Ye; Mohamed Baker Alawieh; Yuki Watanabe; Shigeki Nojima; Yibo Lin; David Z. Pan
>
...
### 14. Timing Driven Partition for Multi-FPGA Systems with TDM Awareness

> **Authors:** Sin-Hong Liou; Sean Liu; Richard Sun; Hung-Ming Chen
>
...
### 15. Transforming Global Routing Report into DRC Violation Map with Convolutional Neural Network

> **Authors:** Wei-Tse Hung; Jun-Yang Huang; Yih-Chih Chou; Cheng-Hong Tsai; Mango Chao
>
...
### 16. Machine Learning-Enabled High-Frequency Low-Power Digital Design Implementation At Advanced Process Nodes

> **Authors:** Siddhartha Nath; Vishal Khandelwal
>
...
### 18. The Law of Attraction: Affinity-Aware Placement Optimization using Graph Neural Networks

> **Authors:** Yi-Chen Lu; Sai Pentapati; Sung Kyu Lim
>
...
### 19. LEO: Line End Optimizer for Sub-7nm Technology Nodes

> **Authors:** Diwesh Pandey; Gustavo E. Tellez; James Leland
>
...
### 20. Analog/Mixed-Signal Layout Optimization using Optimal Well Taps

> **Authors:** Ramprasath S; Meghna Madhusudan; Arvind K. Sharma; Jitesh Poojary; Soner Yaldiz; Ramesh Harjani; Steven M. Burns; Sachin S. Sapatnekar
>
...
> **Authors:** Fangzhou Wang; Jinwei Liu; Evangeline F. Y. Young
>
> **Affiliations:** Department of Computer Science and Engineering, The Chinese University of Hong Kong
>
...
### 22. Placement Initialization via Sequential Subspace Optimization with Sphere Constraints

> **Authors:** Pengwen Chen; Chung-Kuan Cheng; Albert Chern; Chester Holtz; Aoxi Li; Yucheng Wang
>
...
### 23. Novel Transformer Model Based Clustering Method for Standard Cell Design Automation

> **Authors:** Chia-Tung Ho; Ajay Chandna; David Guan; Alvin Ho; Minsoo Kim; Yaguang Li; Haoxing Ren
>
...
### 24. IncreMacro: Incremental Macro Placement Refinement

> **Authors:** Yuan Pu; Tinghuan Chen; Zhuolun He; Jiajun Qin; Chen Bai; Haisheng Zheng; Yibo Lin; Bei Yu
>
...
This article proposes IncreMacro, a novel approach for macro placement refinement in the context of integrated circuit (IC) design. The suggested approach iteratively and incrementally optimizes the placement of macros in order to enhance IC layout routability and timing performance. To achieve this, IncreMacro utilizes several methods, including kd-tree-based macro diagnosis, gradient-based macro shifting, constraint-graph-based LP for macro legalization, and diffusion-based cell migration. By employing these techniques iteratively, IncreMacro meets two critical solution requirements of macro placement: 1) pushing macros toward the chip boundary and 2) preserving the original macro relative positional relationship. The proposed approach has been incorporated into AutoDMP and DREAMPlace 4.0, and is evaluated on seven RISC-V benchmark circuits and four TILOS macro placement circuit designs at the 7-nm technology node. Experimental results show that, compared with the macro placement solution provided by AutoDMP (DREAMPlace 4.0), our approach reduces routed wirelength by 15.1% (14.9%), improves the routed worst negative slack (WNS) and total negative slack (TNS) by 99.9 (82.6%) and 99.9% (81.3%), and reduces the total power consumption by 4.4% (4.3%). Meanwhile, compared with IncreMacro [1], our approach augmented with the cell migration algorithm improves the routed WNS and TNS by 24.7% and 23.1%, and remains the average routed wirelength and total power consumption almost unchanged.

</details>

---

### 25. Cypress: VLSI-Inspired PCB Placement with GPU Acceleration

> **Authors:** Niansong Zhang; Anthony Agnesina; Noor Shbat; Yuval Leader; Zhiru Zhang; Haoxing Ren
>
...
### 26. LEGO-Size: LLM-Enhanced GPU-Optimized Signoff-Accurate Differentiable VLSI Gate Sizing in Advanced Nodes

> **Authors:** Yi-Chen Lu; Kishor Kunal; Geraldo Pradipta; Rongjian Liang; Ravikishore Gandikota; Haoxing Ren
>
...
### 27. Gradient-Guided RC Weighting for Timing-Driven Global Routing

> **Authors:** Liang Xiao; Qinkai Duan; Leilei Jin; Jinwei Liu; Tsung-Yi Ho; Evangeline F.Y. Young; Martin D.F. Wong
>
...
### 28. LiDAR 3.0: Photonics-Aware Planning-Guided Automated Electrical Routing for Large-Scale Active Photonic Integrated Circuits
...
### 1. Pareto Front Analog Layout Placement Using Satisfiability Modulo Theories

> **Authors:** Sherif Saif; Mohamed Dessouky; M. Watheq El-Kharashi; Hazem Abbas; Salwa Nassar
>
...
### 2. Automatic Place-and-Route of Emerging LED-Driven Wires within a Monolithically-Integrated CMOS+III-V Process

> **Authors:** Tushar Krishna; Arya Balachandran; Siau Ben Chiah; Li Zhang; Bing Wang; Cong Wang; Kenneth Lee Eng Kian; Jürgen Michel; Li-Shiuan Peh
>
...
### 3. An Efficient Leakage-Aware Thermal Simulation Approach for 3D-ICs Using Corrected Linearized Model and Algebraic Multigrid

> **Authors:** Chao Yan; Hengliang Zhu; Dian Zhou; Xuan Zeng
>
...
### 4. IR-aware Power Net Routing for Multi-Voltage Mixed-Signal Design

> **Authors:** Shuo-Hui Wang; Yen-Yu Su; Guan-Hong Liou; Mark Po-Hung Lin
>
...
### 5. “Unobserved Corner” Prediction: Reducing Timing Analysis Effort for Faster Design Convergence in Advanced-Node Design

> **Authors:** Andrew Kahng; Uday Mallappa; Lawrence Saul; Shangyuan Tong
>
...
### 6. A Framework for Adding Low-Overhead, Fine-Grained Power Domains to CGRAs

> **Authors:** Ankita Nayak; Keyi Zhang; Raj Setaluri; Alex Carsello; Makai Mann; Stephen Richardson; Rick Bahr; Pat Hanrahan; Mark Horowitz; Priyanka Raina
>
...
### 7. A Learning-Based Thermal Simulation Framework for Emerging Two-Phase Cooling Technologies

> **Authors:** Zihao Yuan; Geoffrey Vaartstra; Prachi Shukla; Zhengmao Lu; Evelyn Wang; Sherief Reda; Ayse Coskun
>
...
### 8. Floating Random Walk Based Capacitance Solver for VLSI Structures with Non-Stratified Dielectrics

> **Authors:** Mingye Song; Ming Yang; Wenjian Yu
>
> **Affiliations:** Tsinghua University
>
> **Year:** `2020` &nbsp;&middot;&nbsp; **Conference:** `DATE` &nbsp;&middot;&nbsp; **Award:** Best Paper Nomination
...
### 9. GANA: Graph Convolutional Network Based Automated Netlist Annotation for Analog Circuits

> **Authors:** Kishor Kunal; Tonmoy Dhar; Meghna Madhusudan; Jitesh Poojary; Arvind Sharma; Wenbin Xu; Steven Burns; Jiang Hu; Ramesh Harjani; Sachin S. Sapatnekar
>
...
> **Authors:** Siting Liu; Peiyu Liao; Rui Zhang; Zhitang Chen; Wenlong Lv; Yibo Lin; Bei Yu
>
...
### 11. Are Analytical Techniques Worthwhile for Analog IC Placement?

> **Authors:** Yishuang Lin; Yaguang Li; Donghao Fang; Meghna Madhusudan; Sachin S. Sapatnekar; Ramesh Harjani; Jiang Hu
>
...
### 12. SAGERoute: Synergistic Analog Routing Considering Geometric and Electrical Constraints with Manual Design Compatibility

> **Authors:** Haoyi Zhang; Xiaohan Gao; Haoyang Luo; Jiahao Song; Xiyuan Tang; Junhua Liu; Yibo Lin; Runsheng Wang; Ru Huang
>
...
### 13. Timing-Driven Global Placement by Efficient Critical Path Extraction
...
### 14. qGDP: Quantum Legalization and Detailed Placement for Superconducting Quantum Computers

> **Authors:** Junyao Zhang; Guanglei Zhou; Feng Cheng; Jonathan Hao-Cheng Ku; Qi Ding; Jiaqi Gu; Hanrui Wang; Hai (Helen) Li; Yiran Chen
>
...
### 15. Lithography Hotspot Detection for Complex Non-Manhattan Layouts via Graph Neural Network

> **Authors:** Bohao Li; Ranran Liu; Yumeng Liu; Cong Jiang; Kang Liu; Bei Yu; Kun Ren; Qi Sun; Cheng Zhuo
>
...
### 1. New Electromigration Modeling and Analysis Considering Time-Varying Temperature and Current Densities

> **Authors:** Hai-Bao Chen; Sheldon X.-D. Tan; Xin Huang; Valeriy Sukharev
>
...
### 2. Simultaneous Template Optimization and Mask Assignment for DSA with Multiple Patterning

> **Authors:** Jian Kuang; Junjie Ye; Evangeline F.Y. Young
>
...
### 3. Algorithm for Synthesis and Exploration of Clock Spines

> **Authors:** Youngchan Kim; Taewhan Kim
>
...
### 5. SRAF Insertion via Supervised Dictionary Learning

> **Authors:** Hao Geng; Haoyu Yang; Yuzhe Ma; Joydeep Mitra; Bei Yu
>
...
### 6. Diffusion Break-Aware Leakage Power Optimization and Detailed Placement in Sub-10nm VLSI

> **Authors:** Sun ik Heo; Andrew B. Kahng; Minsoo Kim; Lutong Wang
>
...
### 7. Equivalent Capacitance Guided Dummy Fill Insertion for Timing and Manufacturability

> **Authors:** Sheng-Jung Yu; Chen-Chien Kao; Chia-Han Huang; Iris Hui-Ru Jiang
>
...
### 8. Integrated Airgap Insertion and Layer Reassignment for Circuit Timing Optimization

> **Authors:** Younggwang Jung; Daijoon Hyun; Youngsoo Shin
>
...
> **Authors:** Wei Li; Yuxiao Qu; Gengjie Chen; Yuzhe Ma; Bei Yu
>
...
### 11. Net Separation-Oriented Printed Circuit Board Placement via Margin Maximization

> **Authors:** Chung-Kuan Cheng; Chia-Tung Ho; Chester Holtz
>
...
### 13. Fully Automated Machine Learning Model Development for Analog Placement Quality Prediction

> **Authors:** Chen-Chia Chang; Jingyu Pan; Zhiyao Xie; Yaguang Li; Yishuang Lin; Jiang Hu; Yiran Chen
>
...
### 14. SPIRAL: Signal-Power Integrity Co-Analysis for High-Speed Inter-Chiplet Serial Links Validation

> **Authors:** Xiao Dong; Songyu Sun; Yangfan Jiang; Jingtong Hu; Dawei Gao; Cheng Zhuo
>
...
### 15. CoPlace: Coherent Placement Engine with Layout-aware Partitioning for 3D ICs

> **Authors:** Bangqi Fu; Lixin Liu; Yang Sun; Wing-Ho Lau; Martin D.F. Wong; Evangeline F.Y. Young
>
...
### 16. PathGen: An Efficient Parallel Critical Path Generation Algorithm

> **Authors:** Che Chang; Boyang Zhang; Cheng-Hsiang Chiu; Dian-Lun Lin; Yi-Hua Chung; Wan-Luan Lee; Zizheng Guo; Yibo Lin; Tsung-Wei Huang
>
...
### 17. C3PO: Commercial-Quality Global Placement via Coherent, Concurrent Timing, Routability, and Wirelength Optimization

> **Authors:** Yi-Chen Lu; Hao-Hsiang Hsiao; Rongjian Liang; Wen-Hao Liu; Haoxing Ren
>
...
### 18. Au-MEDAL: Adaptable Grid Router with Metal Edge Detection And Layer Integration

> **Authors:** Andrew B. Kahng; Seokhyeong Kang; Sehyeon Kim; Jakang Lee; Dooseok Yoon
>
...
### 19. Graph Attention-Based Current Crowding Analysis at TSV Interfaces in 3D Power Delivery Networks

> **Authors:** Zheng Yang; Zhen Zhuang; Tsung-Yi Ho; Sung Kyu Lim
>
...
### 1. Multiple Patterning Layout Decomposition Considering Complex Coloring Rules

> **Authors:** Hua-Yu Chang; Iris Hui-Ru Jiang
>
...
### 2. A Novel Cross-Layer Framework for Early-Stage Power Delivery and Architecture Co-Exploration

> **Authors:** Cheng Zhuo; Kassan Unda; Yiyu Shi; Wei-Kai Shih
>
...
### 3. Legalization Algorithm for Multiple-Row Height Standard Cell Design

> **Authors:** Wing-Kai Chow; Chak-Wa Pui; Evangeline F. Y. Young
>
...
> **Authors:** Jianli Chen; Ziran Zhu; Wenxing Zhu; Yao-Wen Chang
>
...
### 5. Age-Aware Logic and Memory Co-Placement for RRAM-FPGAs

> **Authors:** Yuan Xue; Chengmo Yang; Jingtong Hu
>
...
### 6. Exact Algorithms for Delay-Bounded Steiner Arborescences

> **Authors:** Stephan Held; Benjamin Rockel
>
...
### 7. LithoGAN: End-to-end Lithography Modeling with Generative Adversarial Networks

> **Authors:** Wei Ye; Mohamed Baker Alawieh; Yibo Lin; David Z. Pan
>
...
### 8. DREAMPlace: Deep Learning Toolkit-enabled GPU Acceleration for Modern VLSI Placement
...
### 9. TP-GNN: A Graph Neural Network Framework for Tier Partitioning in Monolithic 3D ICs

> **Authors:** Yi-Chen Lu; Sai Surya Kiran Pentapati; Lingjun Zhu; Kambiz Samadi; Sung Kyu Lim
>
...
### 10. RL-CCD: Concurrent Clock and Data Optimization using Attention-Based Self-Supervised Reinforcement Learning
...
### 11. LLM-HD: Layout Language Model for Hotspot Detection with GDS Semantic Encoding

> **Authors:** Yuyang Chen; Yiwen Wu; Jingya Wang; Tao Wu; Xuming He; Jingyi Yu; Hao Geng
>
...
### 12. INSTA: An Ultra-Fast, Differentiable, Statistical Static Timing Analysis Engine for Industrial Physical Design Applications

> **Authors:** Yi-Chen Lu; Zhizheng Guo; Kishor Kunal; Rongjian Liang; Haoxing Ren
>
...
### 14. DCTS: Differentiable Clock Tree Synthesis Based on Probabilistic Graphical Model

> **Authors:** han zhang; Junming Jiao; Zhi Li; Qixun Tian; Peng Cao
>
...
### 16. FLASH3D: A Fast Layered Analytical Solver for High-Accuracy Steady-State Thermal Simulation of 3D ICs

> **Authors:** Hao Ai; Liang Chen; Jianhua Zhang; Wenxing Zhu
>
...
### 1. A New Methodology for Noise Sensor Placement Based on Association Rule Mining

> **Authors:** Yu-Hsiang Hung; Sheng-Hsin Fang; Hung-Ming Chen; Shen-Min Chen; Chang-Tzu Lin; Chia-Hsin Lee
>
...
### 2. Under-the-cell Routing to Improve Manufacturability

> **Authors:** Alex Vidal-Obiols; Jordi Cortadella; Jordi Petit
>
...
### 3. A Distributed Parallel Random Walk Algorithm for Large-Scale Capacitance Extraction and Simulation

> **Authors:** Mingye Song; Zhezhao Xu; Wei Xue; Wenjian Yu
>
...
### 5. Fast ECO Leakage Optimization Using Graph Convolutional Network

> **Authors:** Wonjae Lee; Yonghwi Kwon; Youngsoo Shin
>
...
### 6. Characterization and Mitigation of Electromigration Effects in TSV-Based Power Delivery Network Enabled 3D-Stacked DRAMs
...
### 7. Machine Learning Based Acceleration Method for Ordered Escape Routing

> **Authors:** Zhiyang Chen; Weiqing Ji; Yihao Peng; Datao Chen; Mingyu Liu; Hailong Yao
>
...
### 8. FAST: Failure-Aware Asynchronous Search with Early Termination for Physical Design

> **Authors:** Sihang Lei; Xueyan Zhao; Yihang Qiu; Biwei Xie; Weiqiang Wang
>
...
### 1. Effective Machine-Learning Models for Predicting Routability During FPGA Placement

> **Authors:** Timothy J. Martin; Shawki Areibi; Gary Grewal
>
...
### 2. Placement Optimization via PPA-Directed Graph Clustering

> **Authors:** Yi-Chen Lu; Tian Yang; Sung Kyu Lim; Haoxing Ren
>
...
### 3. IR-Aware ECO Timing Optimization Using Reinforcement Learning
...
### 4. ORFS-agent: Tool-Using Agents for Chip Design Optimization
...
### 1. Thermal-Aware 3D Symmetrical Buffered Clock Tree Synthesis
...
### 2. Silicon vs. Organic Interposer: PPA and Reliability Tradeoffs in Heterogeneous 2.5D Chiplet Integration

> **Authors:** Jinwoo Kim; Venkata Chaitanya Krishna Chekuri; Nael Mizanur Rahman; Majid Ahadi Dolatsara; Hakki Torun; Madhavan Swaminathan; Saibal Mukhopadhyay; Sung Kyu Lim
>
...
This paper presents an energy-efficient standard-cell library design scheme: MEPNTC, targeting ultra-low-voltage near/sub-V<sub>th</sub> operation. MEPNTC exploits an alternative logic style and inverse-narrow-width-effect (INWE) to extend the minimum energy point operation. A carefully engineered design style is presented to improve the PVT and glitch immunity of the cells while preserving balanced noise margins across a wider V<sub>DD</sub> range. The reduced parasitics and performance boost from both techniques have demonstrated up to 30 % -60 % of energy savings at 0.5V, typical near/sub-V<sub>th</sub> level for general-purpose hardware accelerator benchmarks (32-bit Booth Multiplier, 25- Tap FIR Filter, Forward Discrete Cosine Transform and JPEG Image Compression Units) compared to standard CMOS and INWE aware CMOS designs in 65-nm bulk CMOS technology.
